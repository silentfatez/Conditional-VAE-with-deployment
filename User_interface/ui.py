...
with st.form(key='my_form'):
    ...
    dig = st.number_input('Generate Type', min_value=0,
                          max_value=9, step=1, key="type_input")
    z1 = st.number_input('Enter Latent 1 variable',
                         min_value=0.0, max_value=3.0, key="latent_1")
    z2 = st.number_input('Enter Latent 2 variable',
                         min_value=0.0, max_value=3.0, key="latent_2")
